# Generated by Django 3.2.17 on 2023-02-26 16:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('CUSTOMER', 'Customer'), ('LIBRARY', 'Library'), ('BOOKSTORE', 'Bookstore')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            bases=('Book.user',),
            managers=[
                ('Bookstore', django.db.models.manager.Manager()),
                ('objects', django.contrib.auth.models.UserManager()),
            ],
        ),
        migrations.CreateModel(
